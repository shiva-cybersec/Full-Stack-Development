...
// 1) Introduction to JavaScript
        ...
        // The JavaScript interpreter/compiler(translator we can say) converts our code into
        // binary (0s and 1s) because the computer understands only binary.


// 2) History of JavaScript
        // JavaScript was invented by Brendan Eich.
        // He created it while working at Netscape.
        // It was created in about 10 days.
        // Because it was built very quickly, it had many bugs and errors.
        // To fix those bugs and add new features, many new versions of JavaScript were released.

        // One of the biggest updates was ES6 (ECMAScript 2015).
        // ES6 added many new features and made JavaScript much better.
        // Even though newer versions came after ES6, ES6 is one of the most important versions.

        // JavaScript was first made for the Netscape browser.
        // Later, all browser companies agreed to use JavaScript as the common language.
        // They created a standard called ECMAScript (ES).
        // ECMAScript checks and approves new JavaScript features
        // before browser companies add them to their browsers.
...
// 4) How to run JavaScript in the browser?
        ...
        // Note:
        // Code written in the Console is temporary and is not saved.
...
// 13) statement expressions
    ...
    // Statement:
        // A complete line of code that tells the computer to do something.
        // Example: let x = 10; creates a variable and stores a value.